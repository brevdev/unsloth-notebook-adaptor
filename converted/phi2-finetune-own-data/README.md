# Phi2 Finetune Own Data - NVIDIA Brev Launchable

Fine-tune Phi2 Finetune Own Data with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/phi2-finetune-own-data.ipynb)
...
brev open phi2-finetune-own-data

# Or SSH directly
ssh phi2-finetune-own-data
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/phi2-finetune-own-data.ipynb)
