...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Qwen3_(4B)-GRPO.ipynb)
...
brev open huggingface course-qwen3-4b

# Or SSH directly
ssh huggingface course-qwen3-4b
```
