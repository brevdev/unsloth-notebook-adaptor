...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Qwen2_5_7B_VL_GRPO.ipynb)
...
brev open huggingface course-qwen2-5-7b-vl

# Or SSH directly
ssh huggingface course-qwen2-5-7b-vl
```
