# Kaggle Advanced Llama3 1 (3B) Grpo Lora - NVIDIA Brev Launchable

Fine-tune Kaggle Advanced Llama3 1 (3B) Grpo Lora with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Advanced_Llama3_1_(3B)_GRPO_LoRA.ipynb)
...
brev open kaggle-advanced-llama3-1-3b-grpo-lora

# Or SSH directly
ssh kaggle-advanced-llama3-1-3b-grpo-lora
```
...
git clone <repo-url>
cd kaggle-advanced-llama3-1-3b-grpo-lora
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Advanced_Llama3_1_(3B)_GRPO_LoRA.ipynb)
