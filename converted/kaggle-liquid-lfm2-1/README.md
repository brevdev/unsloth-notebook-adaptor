...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Liquid_LFM2_(1.ipynb)
...
brev open kaggle-liquid-lfm2-1

# Or SSH directly
ssh kaggle-liquid-lfm2-1
```
