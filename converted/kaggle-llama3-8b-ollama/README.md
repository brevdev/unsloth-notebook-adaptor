# Kaggle Llama3 (8B) Ollama - NVIDIA Brev Launchable

Fine-tune Kaggle Llama3 (8B) Ollama with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Llama3_(8B)-Ollama.ipynb)
...
brev open kaggle-llama3-8b-ollama

# Or SSH directly
ssh kaggle-llama3-8b-ollama
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Llama3_(8B)-Ollama.ipynb)
