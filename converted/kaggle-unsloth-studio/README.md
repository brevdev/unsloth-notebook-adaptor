...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Unsloth_Studio.ipynb)
...
brev open kaggle-unsloth-studio

# Or SSH directly
ssh kaggle-unsloth-studio
```
