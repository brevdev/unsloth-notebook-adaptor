# Kaggle Llasa Tts (3B) - NVIDIA Brev Launchable

Fine-tune Kaggle Llasa Tts (3B) with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [Unsloth Colab Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Llasa_TTS_(3B).ipynb)

## 🚀 Quick Start (Brev Console)

1. **Launch on Brev:**
   ```bash
   brev launch kaggle-llasa-tts-3b
   ```
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Llasa_TTS_(3B).ipynb)
