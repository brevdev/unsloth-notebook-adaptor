# Kaggle Meta Synthetic Data Llama3 - NVIDIA Brev Launchable

Fine-tune Kaggle Meta Synthetic Data Llama3 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Meta-Synthetic-Data-Llama3.ipynb)
...
brev open kaggle-meta-synthetic-data-llama3

# Or SSH directly
ssh kaggle-meta-synthetic-data-llama3
```
...
git clone <repo-url>
cd kaggle-meta-synthetic-data-llama3
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Meta-Synthetic-Data-Llama3.ipynb)
