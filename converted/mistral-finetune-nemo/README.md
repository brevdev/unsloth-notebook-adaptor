# Mistral Finetune Nemo - NVIDIA Brev Launchable

Fine-tune Mistral Finetune Nemo with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/mistral-finetune-nemo.ipynb)
...
brev open mistral-finetune-nemo

# Or SSH directly
ssh mistral-finetune-nemo
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/mistral-finetune-nemo.ipynb)
