# Ocr Pdf Analysis - NVIDIA Brev Launchable

Fine-tune Ocr Pdf Analysis with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/ocr-pdf-analysis.ipynb)
...
brev open ocr-pdf-analysis

# Or SSH directly
ssh ocr-pdf-analysis
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/ocr-pdf-analysis.ipynb)
