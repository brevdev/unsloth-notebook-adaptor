...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Gemma3N_(4B)-Vision.ipynb)
...
brev open kaggle-gemma3n-4b-vision

# Or SSH directly
ssh kaggle-gemma3n-4b-vision
```
