...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Mistral_v0.ipynb)
...
brev open kaggle-mistral-v0

# Or SSH directly
ssh kaggle-mistral-v0
```
