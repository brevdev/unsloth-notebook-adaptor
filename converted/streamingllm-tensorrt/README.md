# Streamingllm Tensorrt - NVIDIA Brev Launchable

Fine-tune Streamingllm Tensorrt with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/streamingllm-tensorrt.ipynb)
...
brev open streamingllm-tensorrt

# Or SSH directly
ssh streamingllm-tensorrt
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/streamingllm-tensorrt.ipynb)
