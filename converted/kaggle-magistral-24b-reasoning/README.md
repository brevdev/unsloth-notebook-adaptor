# Kaggle Magistral (24B) Reasoning Conversational - NVIDIA Brev Launchable

Fine-tune Kaggle Magistral (24B) Reasoning Conversational with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Magistral_(24B)-Reasoning-Conversational.ipynb)
...
brev open kaggle-magistral-24b-reasoning

# Or SSH directly
ssh kaggle-magistral-24b-reasoning
```
...
git clone <repo-url>
cd kaggle-magistral-24b-reasoning
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Magistral_(24B)-Reasoning-Conversational.ipynb)
