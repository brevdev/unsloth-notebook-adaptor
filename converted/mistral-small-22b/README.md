...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Mistral_Small_(22B)-Alpaca.ipynb)
...
brev open mistral-small-22b

# Or SSH directly
ssh mistral-small-22b
```
