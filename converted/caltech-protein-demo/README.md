# Caltech Protein Demo - NVIDIA Brev Launchable

Fine-tune Caltech Protein Demo with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/caltech-protein-demo.ipynb)
...
brev open caltech-protein-demo

# Or SSH directly
ssh caltech-protein-demo
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/caltech-protein-demo.ipynb)
