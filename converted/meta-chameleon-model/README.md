# Meta Chameleon Model - NVIDIA Brev Launchable

Fine-tune Meta Chameleon Model with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/meta-chameleon-model.ipynb)
...
brev open meta-chameleon-model

# Or SSH directly
ssh meta-chameleon-model
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/meta-chameleon-model.ipynb)
