...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Orpheus_(3B)-TTS.ipynb)
...
brev open kaggle-orpheus-3b-tts

# Or SSH directly
ssh kaggle-orpheus-3b-tts
```
