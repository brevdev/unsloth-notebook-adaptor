...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-GPT_OSS_MXFP4_(20B)-Inference.ipynb)
...
brev open kaggle-gpt-oss-mxfp4-20b

# Or SSH directly
ssh kaggle-gpt-oss-mxfp4-20b
```
