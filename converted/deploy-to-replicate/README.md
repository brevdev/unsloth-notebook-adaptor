# Deploy To Replicate - NVIDIA Brev Launchable

Fine-tune Deploy To Replicate with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/deploy-to-replicate.ipynb)
...
brev open deploy-to-replicate

# Or SSH directly
ssh deploy-to-replicate
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/deploy-to-replicate.ipynb)
