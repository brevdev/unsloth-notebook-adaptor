# Huggingface Course Gemma3 (1B) Grpo - NVIDIA Brev Launchable

Fine-tune Huggingface Course Gemma3 (1B) Grpo with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [Unsloth Colab Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/HuggingFace Course-Gemma3_(1B)-GRPO.ipynb)

## 🚀 Quick Start (Brev Console)

1. **Launch on Brev:**
   ```bash
   brev launch huggingface course-gemma3-1b
   ```
...
git clone <repo-url>
cd huggingface course-gemma3-1b
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/HuggingFace Course-Gemma3_(1B)-GRPO.ipynb)
