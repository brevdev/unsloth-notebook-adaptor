...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Gemma3_(1B)-GRPO.ipynb)
...
brev open huggingface course-gemma3-1b

# Or SSH directly
ssh huggingface course-gemma3-1b
```
