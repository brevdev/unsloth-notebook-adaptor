# Rag With Local Nim V2 - NVIDIA Brev Launchable

Fine-tune Rag With Local Nim V2 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/RAG_WIth_Local_NIM_V2.ipynb)
...
brev open rag-with-local-nim-v2

# Or SSH directly
ssh rag-with-local-nim-v2
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/RAG_WIth_Local_NIM_V2.ipynb)
