...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-CodeGemma_(7B)-Conversational.ipynb)
...
brev open kaggle-codegemma-7b

# Or SSH directly
ssh kaggle-codegemma-7b
```
