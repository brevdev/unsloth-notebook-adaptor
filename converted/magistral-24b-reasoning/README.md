...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Magistral_(24B)-Reasoning-Conversational.ipynb)
...
brev open magistral-24b-reasoning

# Or SSH directly
ssh magistral-24b-reasoning
```
