...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Qwen3_(4B)-Instruct.ipynb)
...
brev open kaggle-qwen3-4b-instruct

# Or SSH directly
ssh kaggle-qwen3-4b-instruct
```
