...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Gemma3N_(4B)-Audio.ipynb)
...
brev open gemma3n-4b-audio

# Or SSH directly
ssh gemma3n-4b-audio
```
