...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Qwen2_VL_(7B)-Vision.ipynb)
...
brev open kaggle-qwen2-vl-7b-vision

# Or SSH directly
ssh kaggle-qwen2-vl-7b-vision
```
