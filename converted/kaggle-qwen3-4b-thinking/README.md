...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Qwen3_(4B)-Thinking.ipynb)
...
brev open kaggle-qwen3-4b-thinking

# Or SSH directly
ssh kaggle-qwen3-4b-thinking
```
