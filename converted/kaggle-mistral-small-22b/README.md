...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Mistral_Small_(22B)-Alpaca.ipynb)
...
brev open kaggle-mistral-small-22b

# Or SSH directly
ssh kaggle-mistral-small-22b
```
