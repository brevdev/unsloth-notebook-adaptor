# Advanced Llama3 2 (3B) Grpo Lora - NVIDIA Brev Launchable

Fine-tune Advanced Llama3 2 (3B) Grpo Lora with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Advanced_Llama3_2_(3B)_GRPO_LoRA.ipynb)
...
brev open advanced-llama3-2-3b-grpo-lora

# Or SSH directly
ssh advanced-llama3-2-3b-grpo-lora
```
...
git clone <repo-url>
cd advanced-llama3-2-3b-grpo-lora
