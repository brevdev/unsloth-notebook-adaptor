# Rapids Cudf Pandas - NVIDIA Brev Launchable

Fine-tune Rapids Cudf Pandas with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/rapids_cudf_pandas.ipynb)
...
brev open rapids-cudf-pandas

# Or SSH directly
ssh rapids-cudf-pandas
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/rapids_cudf_pandas.ipynb)
