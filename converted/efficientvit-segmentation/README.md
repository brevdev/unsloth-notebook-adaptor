# Efficientvit Segmentation - NVIDIA Brev Launchable

Fine-tune Efficientvit Segmentation with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/efficientvit-segmentation.ipynb)
...
brev open efficientvit-segmentation

# Or SSH directly
ssh efficientvit-segmentation
```
