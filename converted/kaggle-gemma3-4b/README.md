...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Gemma3_(4B).ipynb)
...
brev open kaggle-gemma3-4b

# Or SSH directly
ssh kaggle-gemma3-4b
```
