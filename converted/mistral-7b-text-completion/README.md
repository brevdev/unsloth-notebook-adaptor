...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Mistral_(7B)-Text_Completion.ipynb)
...
brev open mistral-7b-text-completion

# Or SSH directly
ssh mistral-7b-text-completion
```
