# Llama3 To Ollama - NVIDIA Brev Launchable

Fine-tune Llama3 To Ollama with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/llama3-to-ollama.ipynb)
...
brev open llama3-to-ollama

# Or SSH directly
ssh llama3-to-ollama
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/llama3-to-ollama.ipynb)
