...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Phi_3_Medium-Conversational.ipynb)
...
brev open kaggle-phi-3-medium

# Or SSH directly
ssh kaggle-phi-3-medium
```
