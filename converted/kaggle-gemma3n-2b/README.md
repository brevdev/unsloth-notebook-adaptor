...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Gemma3N_(2B)-Inference.ipynb)
...
brev open kaggle-gemma3n-2b

# Or SSH directly
ssh kaggle-gemma3n-2b
```
