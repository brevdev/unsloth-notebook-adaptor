...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Qwen3_(14B).ipynb)
...
brev open qwen3-14b-fine-tuning

# Or SSH directly
ssh qwen3-14b-fine-tuning
```
