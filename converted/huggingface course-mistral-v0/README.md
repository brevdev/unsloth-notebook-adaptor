# Huggingface Course Mistral V0 - NVIDIA Brev Launchable

Fine-tune Huggingface Course Mistral V0 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Mistral_v0.ipynb)
...
brev open huggingface course-mistral-v0

# Or SSH directly
ssh huggingface course-mistral-v0
```
...
git clone <repo-url>
cd huggingface course-mistral-v0
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/HuggingFace Course-Mistral_v0.ipynb)
