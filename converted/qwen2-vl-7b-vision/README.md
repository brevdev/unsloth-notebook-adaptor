...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Qwen2_VL_(7B)-Vision.ipynb)
...
brev open qwen2-vl-7b-vision

# Or SSH directly
ssh qwen2-vl-7b-vision
```
