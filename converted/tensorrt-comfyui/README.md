# Tensorrt Comfyui - NVIDIA Brev Launchable

Fine-tune Tensorrt Comfyui with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/tensorrt-comfyui.ipynb)
...
brev open tensorrt-comfyui

# Or SSH directly
ssh tensorrt-comfyui
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/tensorrt-comfyui.ipynb)
