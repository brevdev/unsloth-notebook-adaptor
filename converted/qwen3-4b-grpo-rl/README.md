...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Qwen3_(4B)_grpo.ipynb)
...
brev open qwen3-4b-grpo-rl

# Or SSH directly
ssh qwen3-4b-grpo-rl
```
