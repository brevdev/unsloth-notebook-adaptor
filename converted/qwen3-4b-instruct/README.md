...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Qwen3_(4B)-Instruct.ipynb)
...
brev open qwen3-4b-instruct

# Or SSH directly
ssh qwen3-4b-instruct
```
