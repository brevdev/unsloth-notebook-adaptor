# Lorawithtensorrt Llm - NVIDIA Brev Launchable

Fine-tune Lorawithtensorrt Llm with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/LoRAwithTensorRT-LLM.ipynb)
...
brev open lorawithtensorrt-llm

# Or SSH directly
ssh lorawithtensorrt-llm
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/LoRAwithTensorRT-LLM.ipynb)
