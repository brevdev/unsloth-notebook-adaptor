# Mistral Finetune Own Data - NVIDIA Brev Launchable

Fine-tune Mistral Finetune Own Data with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/mistral-finetune-own-data.ipynb)
...
brev open mistral-finetune-own-data

# Or SSH directly
ssh mistral-finetune-own-data
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/mistral-finetune-own-data.ipynb)
