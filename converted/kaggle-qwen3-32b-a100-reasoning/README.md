# Kaggle Qwen3 (32B) A100 Reasoning Conversational - NVIDIA Brev Launchable

Fine-tune Kaggle Qwen3 (32B) A100 Reasoning Conversational with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Qwen3_(32B)_A100-Reasoning-Conversational.ipynb)
...
brev open kaggle-qwen3-32b-a100-reasoning

# Or SSH directly
ssh kaggle-qwen3-32b-a100-reasoning
```
...
git clone <repo-url>
cd kaggle-qwen3-32b-a100-reasoning
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Qwen3_(32B)_A100-Reasoning-Conversational.ipynb)
