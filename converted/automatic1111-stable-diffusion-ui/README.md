# Automatic1111 Stable Diffusion Ui - NVIDIA Brev Launchable

Fine-tune Automatic1111 Stable Diffusion Ui with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/automatic1111-stable-diffusion-ui.ipynb)
...
brev open automatic1111-stable-diffusion-ui

# Or SSH directly
ssh automatic1111-stable-diffusion-ui
```
...
git clone <repo-url>
cd automatic1111-stable-diffusion-ui
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/automatic1111-stable-diffusion-ui.ipynb)
