...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Sesame-CSM_(1B).ipynb)
...
brev open sesame-csm-1b-tts

# Or SSH directly
ssh sesame-csm-1b-tts
```
