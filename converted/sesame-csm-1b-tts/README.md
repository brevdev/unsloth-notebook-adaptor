# Sesame-CSM (1B) - NVIDIA Brev Launchable

Fine-tune Sesame-CSM (1B) with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [Unsloth Colab Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Sesame-CSM_(1B).ipynb)

## 🚀 Quick Start (Brev Console)

1. **Launch on Brev:**
   ```bash
   brev launch sesame-csm-1b-tts
   ```
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Sesame-CSM_(1B).ipynb)
