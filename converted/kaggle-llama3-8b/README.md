...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Llama3_(8B)-Conversational.ipynb)
...
brev open kaggle-llama3-8b

# Or SSH directly
ssh kaggle-llama3-8b
```
