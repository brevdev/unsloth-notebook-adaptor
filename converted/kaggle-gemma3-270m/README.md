...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Gemma3_(270M).ipynb)
...
brev open kaggle-gemma3-270m

# Or SSH directly
ssh kaggle-gemma3-270m
```
