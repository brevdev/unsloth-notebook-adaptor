# Qwen3 (4B) Instruct Qat - NVIDIA Brev Launchable

Fine-tune Qwen3 (4B) Instruct Qat with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Qwen3_(4B)_Instruct-QAT.ipynb)
...
brev open qwen3-4b-instruct-qat

# Or SSH directly
ssh qwen3-4b-instruct-qat
```
