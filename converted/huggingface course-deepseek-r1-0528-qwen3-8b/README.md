# Huggingface Course Deepseek R1 0528 Qwen3 (8B) Grpo - NVIDIA Brev Launchable

Fine-tune Huggingface Course Deepseek R1 0528 Qwen3 (8B) Grpo with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-DeepSeek_R1_0528_Qwen3_(8B)_GRPO.ipynb)
...
brev open huggingface course-deepseek-r1-0528-qwen3-8b

# Or SSH directly
ssh huggingface course-deepseek-r1-0528-qwen3-8b
```
...
git clone <repo-url>
cd huggingface course-deepseek-r1-0528-qwen3-8b
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/HuggingFace Course-DeepSeek_R1_0528_Qwen3_(8B)_GRPO.ipynb)
