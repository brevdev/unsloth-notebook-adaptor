# Mixtral Finetune Own Data - NVIDIA Brev Launchable

Fine-tune Mixtral Finetune Own Data with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/mixtral-finetune-own-data.ipynb)
...
brev open mixtral-finetune-own-data

# Or SSH directly
ssh mixtral-finetune-own-data
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/mixtral-finetune-own-data.ipynb)
