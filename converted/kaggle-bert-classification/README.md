...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-bert_classification.ipynb)
...
brev open kaggle-bert-classification

# Or SSH directly
ssh kaggle-bert-classification
```
