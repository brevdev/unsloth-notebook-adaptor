# Kaggle Meta Synthetic Data Llama3 2 (3B) - NVIDIA Brev Launchable

Fine-tune Kaggle Meta Synthetic Data Llama3 2 (3B) with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Meta_Synthetic_Data_Llama3_2_(3B).ipynb)
...
brev open kaggle-meta-synthetic-data-llama3-2-3b

# Or SSH directly
ssh kaggle-meta-synthetic-data-llama3-2-3b
```
...
git clone <repo-url>
cd kaggle-meta-synthetic-data-llama3-2-3b
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Meta_Synthetic_Data_Llama3_2_(3B).ipynb)
