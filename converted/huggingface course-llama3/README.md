...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Llama3.ipynb)
...
brev open huggingface course-llama3

# Or SSH directly
ssh huggingface course-llama3
```
