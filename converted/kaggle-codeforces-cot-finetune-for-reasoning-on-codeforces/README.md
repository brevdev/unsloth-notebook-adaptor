# Kaggle Codeforces Cot Finetune For Reasoning On Codeforces - NVIDIA Brev Launchable

Fine-tune Kaggle Codeforces Cot Finetune For Reasoning On Codeforces with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-CodeForces-cot-Finetune_for_Reasoning_on_CodeForces.ipynb)
...
brev open kaggle-codeforces-cot-finetune-for-reasoning-on-codeforces

# Or SSH directly
ssh kaggle-codeforces-cot-finetune-for-reasoning-on-codeforces
```
...
git clone <repo-url>
cd kaggle-codeforces-cot-finetune-for-reasoning-on-codeforces
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-CodeForces-cot-Finetune_for_Reasoning_on_CodeForces.ipynb)
