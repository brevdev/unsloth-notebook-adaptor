# Mixtral Finetune - NVIDIA Brev Launchable

Fine-tune Mixtral Finetune with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/mixtral-finetune.ipynb)
...
brev open mixtral-finetune

# Or SSH directly
ssh mixtral-finetune
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/mixtral-finetune.ipynb)
