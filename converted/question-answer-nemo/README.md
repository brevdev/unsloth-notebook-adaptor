# Question Answer Nemo - NVIDIA Brev Launchable

Fine-tune Question Answer Nemo with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/question_answer_nemo.ipynb)
...
brev open question-answer-nemo

# Or SSH directly
ssh question-answer-nemo
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/question_answer_nemo.ipynb)
