...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Mistral_Nemo_(12B)-Alpaca.ipynb)
...
brev open kaggle-mistral-nemo-12b

# Or SSH directly
ssh kaggle-mistral-nemo-12b
```
