...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Spark_TTS_(0_5B).ipynb)
...
brev open kaggle-spark-tts-0-5b

# Or SSH directly
ssh kaggle-spark-tts-0-5b
```
