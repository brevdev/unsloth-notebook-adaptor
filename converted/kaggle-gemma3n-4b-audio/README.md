...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Gemma3N_(4B)-Audio.ipynb)
...
brev open kaggle-gemma3n-4b-audio

# Or SSH directly
ssh kaggle-gemma3n-4b-audio
```
