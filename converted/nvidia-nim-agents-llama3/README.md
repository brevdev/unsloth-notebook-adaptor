# Nvidia Nim Agents Llama3 - NVIDIA Brev Launchable

Fine-tune Nvidia Nim Agents Llama3 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/nvidia_nim_agents_llama3.ipynb)
...
brev open nvidia-nim-agents-llama3

# Or SSH directly
ssh nvidia-nim-agents-llama3
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/nvidia_nim_agents_llama3.ipynb)
