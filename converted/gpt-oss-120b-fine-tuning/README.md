...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/gpt-oss-120b.ipynb)
...
brev open gpt-oss-120b-fine-tuning

# Or SSH directly
ssh gpt-oss-120b-fine-tuning
```
