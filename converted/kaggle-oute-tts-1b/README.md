...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Oute_TTS_(1B).ipynb)
...
brev open kaggle-oute-tts-1b

# Or SSH directly
ssh kaggle-oute-tts-1b
```
