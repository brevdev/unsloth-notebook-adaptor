# Huggingface Course Gemma3 (4B) Vision Grpo - NVIDIA Brev Launchable

Fine-tune Huggingface Course Gemma3 (4B) Vision Grpo with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Gemma3_(4B)-Vision-GRPO.ipynb)
...
brev open huggingface course-gemma3-4b-vision

# Or SSH directly
ssh huggingface course-gemma3-4b-vision
```
...
git clone <repo-url>
cd huggingface course-gemma3-4b-vision
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/HuggingFace Course-Gemma3_(4B)-Vision-GRPO.ipynb)
