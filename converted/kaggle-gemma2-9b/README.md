...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Gemma2_(9B)-Alpaca.ipynb)
...
brev open kaggle-gemma2-9b

# Or SSH directly
ssh kaggle-gemma2-9b
```
