...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Qwen3-VL_(8B).ipynb)
...
brev open qwen3-vl-8b-vision

# Or SSH directly
ssh qwen3-vl-8b-vision
```
