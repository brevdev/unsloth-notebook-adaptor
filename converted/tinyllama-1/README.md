# Tinyllama (1 - NVIDIA Brev Launchable

Fine-tune Tinyllama (1 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [Unsloth Colab Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/TinyLlama_(1.ipynb)

## 🚀 Quick Start (Brev Console)

1. **Launch on Brev:**
   ```bash
   brev launch tinyllama-1
   ```
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/TinyLlama_(1.ipynb)
