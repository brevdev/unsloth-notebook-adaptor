...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/HuggingFace Course-Qwen2.ipynb)
...
brev open huggingface course-qwen2

# Or SSH directly
ssh huggingface course-qwen2
```
