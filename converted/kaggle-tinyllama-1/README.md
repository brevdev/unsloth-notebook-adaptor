...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-TinyLlama_(1.ipynb)
...
brev open kaggle-tinyllama-1

# Or SSH directly
ssh kaggle-tinyllama-1
```
