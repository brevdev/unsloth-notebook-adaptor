# Comfyui - NVIDIA Brev Launchable

Fine-tune Comfyui with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/comfyui.ipynb)
