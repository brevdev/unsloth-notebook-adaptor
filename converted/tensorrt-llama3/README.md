# Tensorrt Llama3 - NVIDIA Brev Launchable

Fine-tune Tensorrt Llama3 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/tensorrt-llama3.ipynb)
