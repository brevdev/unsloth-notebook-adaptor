...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Zephyr_(7B)-DPO.ipynb)
...
brev open kaggle-zephyr-7b-dpo

# Or SSH directly
ssh kaggle-zephyr-7b-dpo
```
