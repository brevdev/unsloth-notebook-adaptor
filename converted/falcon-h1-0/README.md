# Falcon H1 (0 - NVIDIA Brev Launchable

Fine-tune Falcon H1 (0 with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [Unsloth Colab Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Falcon_H1_(0.ipynb)

## 🚀 Quick Start (Brev Console)

1. **Launch on Brev:**
   ```bash
   brev launch falcon-h1-0
   ```
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Falcon_H1_(0.ipynb)
