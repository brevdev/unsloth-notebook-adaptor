...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/bert_classification.ipynb)
...
brev open bert-classification

# Or SSH directly
ssh bert-classification
```
