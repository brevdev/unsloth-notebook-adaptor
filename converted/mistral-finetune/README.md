# Mistral Finetune - NVIDIA Brev Launchable

Fine-tune Mistral Finetune with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/mistral-finetune.ipynb)
...
brev open mistral-finetune

# Or SSH directly
ssh mistral-finetune
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/mistral-finetune.ipynb)
