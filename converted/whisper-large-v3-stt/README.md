...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Whisper_Large_V3.ipynb)
...
brev open whisper-large-v3-stt

# Or SSH directly
ssh whisper-large-v3-stt
```
