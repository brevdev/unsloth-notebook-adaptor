# Tensorrt Mistral - NVIDIA Brev Launchable

Fine-tune Tensorrt Mistral with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/tensorrt_mistral.ipynb)
...
brev open tensorrt-mistral

# Or SSH directly
ssh tensorrt-mistral
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/tensorrt_mistral.ipynb)
