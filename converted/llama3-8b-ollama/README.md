...
🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Llama3_(8B)-Ollama.ipynb)
...
brev open llama3-8b-ollama

# Or SSH directly
ssh llama3-8b-ollama
```
