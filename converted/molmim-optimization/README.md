# Molmim Optimization - NVIDIA Brev Launchable

Fine-tune Molmim Optimization with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/molmim-optimization.ipynb)
...
brev open molmim-optimization

# Or SSH directly
ssh molmim-optimization
```
...
- [Original Notebook](https://github.com/unslothai/notebooks/blob/main/nb/molmim-optimization.ipynb)
