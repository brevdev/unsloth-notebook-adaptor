# Kaggle Mistral (7B) Text Completion - NVIDIA Brev Launchable

Fine-tune Kaggle Mistral (7B) Text Completion with Unsloth on NVIDIA GPUs using Brev.

🔗 **Original Notebook:** [View on GitHub](https://github.com/unslothai/notebooks/blob/main/nb/Kaggle-Mistral_(7B)-Text_Completion.ipynb)
...
brev open kaggle-mistral-7b-text-completion

# Or SSH directly
ssh kaggle-mistral-7b-text-completion
```
...
git clone <repo-url>
cd kaggle-mistral-7b-text-completion
...
- [Original Notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Kaggle-Mistral_(7B)-Text_Completion.ipynb)
