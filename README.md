...
| **Kaggle Llama3** | Alpaca | L4 (16GB) | [View Notebook](converted/kaggle-llama3/Kaggle-Llama3.1_(8B)-Alpaca.ipynb) |
...
| **Llama3 (8B) Conversational** | Alpaca | L4 (16GB) | [View Notebook](converted/llama3-8b/Llama3_(8B)-Alpaca.ipynb) |
...
| **Mistral V0** | CPT | L4 (16GB) | [View Notebook](converted/mistral-v0/Mistral_v0.3_(7B)-CPT.ipynb) |
...
| **Qwen3 (14B)** | Alpaca | A100-40GB (24GB) | [View Notebook](converted/qwen3-14b-fine-tuning/Qwen3_(14B)-Alpaca.ipynb) |
...
| **Kaggle Qwen2** | Vision | L4 (16GB) | [View Notebook](converted/kaggle-qwen2/Kaggle-Qwen2.5_VL_(7B)-Vision.ipynb) |
...
| **Qwen3-VL (8B)** | Vision | A100-40GB (24GB) | [View Notebook](converted/qwen3-vl-8b-vision/HuggingFace Course-Qwen3_VL_(8B)-Vision-GRPO.ipynb) |

### Text-to-Speech (TTS) Notebooks

| Model | Type | GPU Requirements | Notebook Link |
|-------|------|------------------|---------------|
| **Sesame-CSM (1B)** | TTS | T4 (12GB) | [View Notebook](converted/sesame-csm-1b-tts/Sesame_CSM_(1B)-TTS.ipynb) |
...
| **gpt-oss-120b** | Fine-tuning | A100-80GB (80GB) | [View Notebook](converted/gpt-oss-120b-fine-tuning/gpt-oss-(120B)_A100-Fine-tuning.ipynb) |
| **gpt-oss-20b** | Fine-tuning | A100-40GB (24GB) | [View Notebook](converted/gpt-oss-20b-fine-tuning/gpt_oss_(20B)_Reinforcement_Learning_2048_Game_DGX_Spark.ipynb) |
