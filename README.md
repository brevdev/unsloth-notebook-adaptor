...
| **Llama3 (8B) Alpaca** | Conversational | L4 (16GB) | [View Notebook](converted/llama3-(8b)-alpaca/Llama3_(8B)-Conversational.ipynb) |
...
| **Phi-4 (14B)** | Conversational | A100-40GB (24GB) | [View Notebook](converted/phi-4-(14b)/Phi_4-Conversational.ipynb) |
...
| **Qwen3-VL (8B)** | Vision | A100-40GB (24GB) | [View Notebook](converted/qwen3-vl-(8b)/Kaggle-Qwen3_VL_(8B)-Vision.ipynb) |

### Text-to-Speech (TTS) Notebooks

| Model | Type | GPU Requirements | Notebook Link |
|-------|------|------------------|---------------|
| **Sesame-CSM (1B)** | TTS | T4 (12GB) | [View Notebook](converted/sesame-csm-(1b)/Kaggle-Sesame_CSM_(1B)-TTS.ipynb) |
...
| **gpt-oss-120b** | Fine-tuning | A100-80GB (80GB) | [View Notebook](converted/gpt-oss-120b/Kaggle-gpt-oss-(120B)_A100-Fine-tuning.ipynb) |
| **gpt-oss-20b** | Fine-tuning | A100-40GB (24GB) | [View Notebook](converted/gpt-oss-20b/Kaggle-gpt-oss-(20B)-Fine-tuning.ipynb) |
